...
Feature: Watch data source
  ...
  Scenario: Watch current data source
    Given I am viewing a data source and have only one default watch list (named "My Watch List")
    When I click on the "Watch" link
    Then the data source is added to "My Watch List"

  Scenario: Unwatch current data source
    Given I am viewing a data source that I am currently watching, listed under "My Watch List"
  ...
  Scenario: Create a new custom Watch List
    Given I am viewing my Watch Lists, currently consisting of a single watch list named "My Watch List"
