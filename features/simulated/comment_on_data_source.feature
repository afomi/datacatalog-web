Feature: Comment on a data source
  ...
  Scenario: Leave comment with a positive rating
    Given that I am viewing a data source that I found useful
  ...
  Scenario: Give a negative rating to a data source
    Given that I am viewing a data source I did not find useful
  ...
  Scenario: File a bug report
    Given that I am viewing a data source where I found a small problem with the data
